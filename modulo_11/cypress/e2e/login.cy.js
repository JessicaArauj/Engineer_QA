...
context('Funcionalidade Login', () => {   // posso utilizar describe no lugar de context
    ...
    it('Deve exibir uma mensagem de erro ao inserir usuário inválido', () => {  // cenário negativo
    ...
    it('Deve exibir uma mensagem de erro ao inserir senha inválida', () => { // cenário negativo
        cy.visit('minha-conta')
        cy.get('#username').type('aluno_ebac@teste.com')
        cy.get('#password').type('teste@teste')
        cy.get('.woocommerce-form > .button').click()
